const state = {
    university: [
        ...
        },
        {
            ...
            end_date: 'january',
            perks: { swags: true, stipend: false, cash_price: false, internships_opportunity: false, certificates: true, surprise_gifts: true },
            description: 'The Kharagpur Winter of Code, often abbreviated as KWoC, is an annual five week long program where students new or unknown to free and open-source software contribute to coding projects registered in the program by experienced mentors or project owners and gain experience in contributing to open source software.',
        ...
        {
            _id: 4,
            image: 'https://opencodeiiita.github.io/dist/images/Logo.png',
        ...
        },
        {
            ...
            timeline: 'https://slop.dscdaiict.in/',
            link: 'https://slop.dscdaiict.in/',
            color: '#FFF2CC',
        },
        {
            _id: 8,
